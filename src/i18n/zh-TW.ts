const zhTW = {
  ...
  user: { role: '廠長', name: '威明', fullName: '陳威明' },
  ...
  reportContent: {
    ...
    coolingPumpCP104: '冷卻幫浦 CP-104',
    electricalPanelEP011: '電氣盤 EP-011',
    airCompressorAC201: '空氣壓縮機 AC-201',
    mixingTankMT220: '攪拌槽 MT-220',
    inspectorWangMeiLing: '王美玲',
    inspectorWangShort: '王',
    inspectorChenWeiMing: '陳威明',
    inspectorLinJiaHao: '林家豪',
    inspectorLiuKuoCheng: '劉國誠',
  },
  ...
  settings: {
    ...
    form: {
      ...
      codePlaceholder: '例如：CP-104',
      descriptionPlaceholder: '選填說明...',
      locationPlaceholder: '例如：A棟，2樓',
      tagsPlaceholder: '輸入標籤後按 Enter',
      required: '必填',
      selectProfile: '選擇規則設定檔...',
    },
    criticality: {
      critical: '關鍵',
      normal: '一般',
    ...
    photoMapping: {
      ...
      deviceId: '裝置 ID',
      cameraId: '攝影機 ID',
      defaultComponent: '預設元件',
      remarks: '備註',
      noMappings: '尚未設定照片對應',
    },
    confirmDelete: '確定要刪除此項目？此操作無法復原。',
