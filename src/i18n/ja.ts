const ja = {
  ...
  user: { role: '工場長', name: 'ウェイミン', fullName: 'チェン・ウェイミン' },
  ...
  reportContent: {
    ...
    coolingPumpCP104: '冷却ポンプ CP-104',
    electricalPanelEP011: '電気盤 EP-011',
    airCompressorAC201: 'エアコンプレッサー AC-201',
    mixingTankMT220: '撹拌タンク MT-220',
    inspectorWangMeiLing: 'ワン・メイリン',
    inspectorWangShort: 'ワン',
    inspectorChenWeiMing: 'チェン・ウェイミン',
    inspectorLinJiaHao: 'リン・ジャハオ',
    inspectorLiuKuoCheng: 'リウ・グオチェン',
  },
  ...
  settings: {
    ...
    form: {
      ...
      codePlaceholder: '例：CP-104',
      descriptionPlaceholder: '説明（任意）...',
      locationPlaceholder: '例：A棟、2階',
      tagsPlaceholder: 'タグを入力してEnterキー',
      required: '必須',
      selectProfile: 'ルールプロファイルを選択...',
    },
    criticality: {
      critical: 'クリティカル',
      normal: '通常',
    ...
    saveNode: '変更を保存',
    deleteNode: '削除',
    noSelection: 'ツリーからノードを選択して詳細を表示',
    componentTable: {
      name: 'コンポーネント',
      type: 'タイプ',
      criticality: '重要度',
    ...
    ruleProfiles: {
      ...
      severity: '重大度',
      addRule: 'ルールを追加',
      noProfiles: 'ルールプロファイルが未定義',
      noRules: 'このプロファイルにルールなし',
